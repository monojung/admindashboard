<!-- Main Sidebar Container -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header"><h3><i class="nav-icon fas fa-tachometer-alt"> </i>  ภาพรวมระบบ</h3></li>
          ...
          <li class="nav-header"><h3><i class="nav-icon fas fa-wallet"> </i>  จัดเก็บรายได้</h3></li>
  ...
  <script>
  // เมื่อโหลดหน้าเว็บเสร็จ ให้สั่งพับเมนูทันที
  $(document).ready(function() {
    $('[data-widget="pushmenu"]').PushMenu('collapse');
    
    // ป้องกันกรณี AdminLTE จำสถานะเดิมจาก LocalStorage (ถ้ามี)
    if (typeof(Storage) !== "undefined") {
      localStorage.setItem('remember_adminlte_sidebar', 'collapsed');
    }
  });
</script>